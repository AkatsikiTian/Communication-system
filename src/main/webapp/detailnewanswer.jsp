    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="table-responsive">
                            <div>问题标题：${newanswers[param.index].title}</div>
                            <div>问题提问时间：${newanswers[param.index].time}</div>
                            <div>问题所属课程：${newanswers[param.index].cname}</div>
                            <div>问题内容：${newanswers[param.index].content}</div>
                <hr/>
